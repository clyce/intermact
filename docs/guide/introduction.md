...
更完整的接口契约与修订记录见仓库 [`dev-docs/design.md`](https://github.com/clyce/intermact/blob/main/dev-docs/design.md) 与 [`dev-docs/dev-roadmap.md`](https://github.com/clyce/intermact/blob/main/dev-docs/dev-roadmap.md)。
