...
/**
 * M11 / design.md §12.3: an explorable. Drag the handle along the curve to move
 * `x`; the tangent line and the slope readout recompute live (drag �?signal �? * derived geometry). Combines M8 constructs with M11 interaction.
 */
